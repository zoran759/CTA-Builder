    ...
    return (
      <div className={`cta-design ${isActive ? 'active' : ''}`}>
        <div className="cta-content-container">
          ...
          <div className={`cta-content ${this.ifTriggerButton() ? "d-none" : ''}`} style={{ width: data.width + "px", background: data.background, border: data.stroke ? data.stroke : "none", borderRadius: data.corner + "px", borderColor: data.stroke, boxShadow: data.shadow }}>
